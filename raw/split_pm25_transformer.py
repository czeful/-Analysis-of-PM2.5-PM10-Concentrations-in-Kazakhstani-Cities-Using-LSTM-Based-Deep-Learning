...
import pandas as pd
IN_FILE = Path(r"C:\air_quality_project\processed\training_pm25_transformer_clean_astana.csv")

TRAIN_OUT = Path(r"C:\air_quality_project\processed\train_pm25.csv")
VALID_OUT = Path(r"C:\air_quality_project\processed\valid_pm25.csv")
TEST_OUT = Path(r"C:\air_quality_project\processed\test_pm25.csv")
