...
TRAIN_FILE = Path(r"C:\air_quality_project\processed\train_pm10.csv")
VALID_FILE = Path(r"C:\air_quality_project\processed\valid_pm10.csv")
TEST_FILE  = Path(r"C:\air_quality_project\processed\test_pm10.csv")

OUT_ROOT = Path(r"C:\air_quality_project\processed\sequence_data_pm10_by_city")
