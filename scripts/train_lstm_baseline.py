...
# PATHS
# ======================
DATA_DIR = Path(r"C:\air_quality_project\processed\sequence_data")
MODEL_DIR = Path(r"C:\air_quality_project\processed\models")
...
BEST_MODEL_FILE = MODEL_DIR / "lstm_baseline_best.pt"
METRICS_FILE = MODEL_DIR / "lstm_baseline_metrics.json"
...
class LSTMBaseline(nn.Module):
    ...
    def forward(self, x):
        ...
        # take last hidden state of top LSTM layer
