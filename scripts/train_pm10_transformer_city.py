...
DATA_DIR = Path(r"C:\air_quality_project\processed\sequence_data_pm10_by_city") / CITY
MODEL_DIR = Path(r"C:\air_quality_project\processed\models_pm10_by_city") / CITY
...
BEST_MODEL_FILE = MODEL_DIR / "pm10_transformer_best.pt"
METRICS_FILE = MODEL_DIR / "pm10_transformer_metrics.json"
...
class PM10Transformer(nn.Module):
    def __init__(
        self,
        input_size,
        d_model=128,
...
for epoch in range(1, MAX_EPOCHS + 1):
    ...
    print(
        ...
        f"Valid PM10 R2: {valid_metrics['R2']:.4f}"
    )
...
for split_name, metrics in [
    ...
    print(f"\n{split_name}")
    print(f"PM10 -> RMSE: {metrics['RMSE']:.4f}, "
